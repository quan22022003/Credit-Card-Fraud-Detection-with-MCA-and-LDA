...
d_cv <- lda(fraud ~ log_distance_from_home + log_distance_from_last_transaction + log_ratio_to_median_purchase_price + PC1 + PC2 + PC3 + PC4, data = card_extracted, CV = TRUE)
```
